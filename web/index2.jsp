                        ...
                        <div class="profiletab-content">
                            <div id="tab1" class="tab active"> <img src="img/cat.JPG" alt="image" height="130" width="110">
                                ...
                                <table align="left" class="table1">
                                    ...
                                    // Declare variables                        
                                    String URL = "jdbc:sqlserver://localhost:1433/SchoolDB";
                                    String USER = "sa";
                                    String PASSWORD ="ZooS33k9989";
                                    ...
                                    ResultSet rs = null;
                                      ...
                                      //student constructor
                                      public Student(){
                                           //try catch block to catch any sql exception
                                          try{
                                              //try to connect to the database
                                              connection = DriverManager.getConnection(URL, USER, PASSWORD);
                                              //prepare the select student statment
                                              stmnt = connection.prepareStatement(
                                                        "SELECT lastName, firstName, studentSid, dob, gender FROM Student where studentSid = 100000 ");
                                              
                                          }catch(SQLException e){
                                              e.printStackTrace();
                                          }
                                      }
                                      //metod that will return teh result set called getStudents()
                                      public ResultSet getStudent(){
                                          //the execution query can thrown anexception as well
                                          try{
                                ...
                                <%
                                 ...
                                 %>
                                 <%//while there is still a record, to generate the value%>
                                 <% while (rs.next()) { 
